...
function randomCode(n){
	...
	return mycode;//返回function randomCode
}
...
// 	//多个属性时，会覆盖，所以拼接一个定时器名字，
// 	//width->widthTimer,opacity->opacityTimer;
...
// 		//获取当前值left,top,width,opacity
		
// 		var current = getComputedStyle(ele)[attr];
// 		//有可能得到100px 0.5  ,45deg...
...
// 		//提取值
// 		current = parseFloat(current);//保留小位数0.5
